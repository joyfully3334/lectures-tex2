...
\newcommand{\then}     {\;\,}
\newcommand{\lm}  [1][]{\displaystyle \lim_{#1} \textstyle}
\newcommand{\dlm} [2]  {\displaystyle \lim_{\substack{#1 \\ #2}} \textstyle}
\newcommand{\sm}  [2]  {\displaystyle \sum_{#1}^{#2} \textstyle}
\newcommand{\smm} [2]  {\sum\limits_{#1}^{#2}}
\newcommand{\prd} [2]  {\displaystyle \prod_{#1}^{#2} \textstyle}
...
\newcommand{\sfd} [1]{\left( #1 \right)}   % Small Parentheses
\newcommand{\sfb} [1]{\left[ #1 \right]}   % Small Brackets
\newcommand{\sfp} [1]{\left| #1 \right|}   % Small Pipes
\newcommand{\sfpp}[1]{\left\| #1 \right\|} % Small double PiPes
\newcommand{\sfdp}[1]{\left\| #1 \right\|} % Small Double Pipes
\newcommand{\sfP} [1]{\left\| #1 \right\|} % Small double Pipes
\newcommand{\sfc} [1]{\left\{ #1 \right\}} % Small Curly braces
