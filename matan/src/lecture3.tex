...
\jprf{
  По \hyperref[lemma6.1.2]{лемме 2}, $f(E)$ связно, тогда по
  \hyperref[lemma6.1.3]{лемме 1} $f(E)$ --- промежуток. Тогда
